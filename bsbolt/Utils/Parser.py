...
parser = argparse.ArgumentParser(description='BiSulfite Bolt v1.4.6',
...
index_parser.add_argument('-B', type=int, default=10000000, help='Block size for bwtsw algorithm, increasing '
                                                                 'block will speed up indexing and increase memory '
                                                                 'consumption')
...
call_meth_parser.add_argument('-verbose', action="store_true", default=False, help='Verbose Output')
call_meth_parser.add_argument('-text', action="store_true", default=False,
                              help='Output plain text files, default=False')
call_meth_parser.add_argument('-ignore-ov', action="store_true", default=True,
...
sim_parser.add_argument('-RL', type=int, default=125, help='Simulated Read Length [125]')
sim_parser.add_argument('-RD', type=int, default=20, help='Simulated Read Depth [20]')
...
sim_parser.add_argument('-MR', type=float, default=0.005, help='Mutation rate [0.005]')
sim_parser.add_argument('-MI', type=float, default=0.20, help='Mutation indel fraction [0.20]')
sim_parser.add_argument('-ME', type=float, default=0.20, help='Mutation indel extension probability [0.20]')
sim_parser.add_argument('-RS', type=int, default=-1, help='Random seed for variant generation [-1]')
...
sim_parser.add_argument('-IM', type=int, default=50, help='Insert length mean [50]')
sim_parser.add_argument('-SM', type=int, default=50, help='Insert length standard deviation [50]')
