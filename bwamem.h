...
typedef struct { // This struct is only used for the convenience of API.
	...
	int cg_meth, cg_unmeth, ch_meth, ch_unmeth; // observed base status 
...
extern "C" {
	 ...
	 * @param bwt    FM-index of the reference sequence
	 * @param bns    Information of the reference
	 * @param pac    2-bit encoded reference (bisulfite converted)
	 * @param opac   2-bit encoded reference (not bisulfite converted)
	 ...
	 */
	mem_aln_t mem_reg2aln(const mem_opt_t *opt, const bntseq_t *bns, const uint8_t *pac, const uint8_t *opac, int l_seq, const char *seq, const mem_alnreg_t *ar, const char *oquery_);
	mem_aln_t mem_reg2aln2(const mem_opt_t *opt, const bntseq_t *bns, const uint8_t *pac, const uint8_t *opac, int l_seq, const char *seq, const mem_alnreg_t *ar, const char *name, const char *oquery_);
