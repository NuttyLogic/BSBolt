...
import subprocess
import pysam
from BSB_Align.BT2_Mapping import Bowtie2Alignment
from BSB_Align.ProcessSamReads import ProcessSamAlignment
from BSB_Align.TabSamIterator import TabSamIterator
from BSB_Align.AlignmentHelpers import write_bam_line
...
class BisulfiteAlignmentAndProcessing:
    ...
    def get_output_object(self):
        ...
        #sam_header['PG'] = {'ID': '01', 'PN': 'BsseekerRefactor', 'CL': self.command_line_arg}
