...
mv -f $depbase.Tpo $depbase.Po
g++  -g -O2  -o art_illumina art_illumina_src/art_illumina.o art_illumina_src/art_qual_scale.o art_illumina_src/empdist.o art_illumina_src/readSeqFile.o art_illumina_src/seqRead.o art_illumina_src/samRead.o  -WL,-Bstatic -lgsl -WL,-Bstatic -lgslcblas -WL,-Bstatic -lm
