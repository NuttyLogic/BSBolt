...
LOBJS=		utils.o kthread.o kstring.o ksw.o bwt.o bntseq.o bwa.o bwamem.o bwamem_pair.o bwamem_extra.o malloc_wrap.o \
			QSufSort.o bwt_gen.o rope.o rle.o is.o bwtindex.o bs_helpers.o bs_sorter_wrapper.o bs_sorter.o
...
bwa:libbwa.a $(AOBJS) main.o
		g++ $(CFLAGS) $(DFLAGS) $(AOBJS) main.o -o $@ -L. -Bstatic -lbwa $(LIBS) 
...
bs_helpers.o: bs_helpers.h 
bs_sorter.o: bs_sorter.h
bs_sorter_wrapper.o: bs_sorter_wrapper.h bs_sorter.h
