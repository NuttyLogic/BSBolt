...
bt2_commands = {'fastq1': '/Users/colinfarrell/Documents/BSBolt/Tests/TestSimulations/BSB_pe_meth_1.fastq',
                'fastq2': '/Users/colinfarrell/Documents/BSBolt/Tests/TestSimulations/BSB_pe_meth_2.fastq',
                'undirectional_library': True,
                'bowtie2_commands':
                ['--quiet', '--no-mixed', '--no-discordant', '--sam-nohead', '--reorder',
                 '-k', '10', '-p', '2', '-L', '20', '-D', '40', '--end-to-end', '--score-min',
                 'L,-0.6,-0.6', '-I', '0', '-X', '500'],
                'bsb_database': '/Users/colinfarrell/Documents/BSBolt/Tests/TestData/BSB_Test_DB_S/',
                'bowtie2_path': '/Users/colinfarrell/Documents/BSBolt/External/BT2/bowtie2-2.3.4.3-macos-x86_64/bowtie2',
                'output_path': '/Users/colinfarrell/Documents/BSBolt/Tests/BSB_pe_test',}

test_align = BisulfiteAlignmentAndProcessing(**bt2_commands)
test_align.launch_bisulfite_aligment()